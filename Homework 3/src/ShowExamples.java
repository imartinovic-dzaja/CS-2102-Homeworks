...
public class ShowExamples 
{
	...
	/*Subtasks
	 * filter out overnight and special shows
	 * keep track of daytime, primetime and latenight shows 
	 * sorts out daytime, primetime and latenight shows 
	 * using the accumulators construct and return a ShowSummary
	 * */
