...
public class CompileCheck {
 public static void main(String[] args) {
   ...
   RugbyResult rugbyResultCheck = new RugbyResult(rugbyTeamCheck, rugbyTeamCheck,
10.5,15.2);
   RoboticsResult robotsResultCheck = new RoboticsResult(robotsTeamCheck,
robotsTeamCheck, 3.1, 5, true, 3.2, 2, false);
   Match rugbyMatchCheck = new Match(rugbyTeamCheck, rugbyTeamCheck,
rugbyResultCheck);
